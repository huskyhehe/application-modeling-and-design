...
public class StudentProfile {
    ...
    public void registerForCourse(CourseLoad cl, CourseOffer co) {
        SeatAssignment sa = co.assignEmptySeat(cl);
        sa.setStudent(this);
    } 
    
    public void registerForCourse(String semester, CourseOffer co) {
        CourseLoad cl = this.newCourseLoad(semester);
        SeatAssignment sa = co.assignEmptySeat(cl);
        sa.setStudent(this);
